...
//TDOD: FIX THIS PIECE OF SHIT
const registerDriver = async (req, res) => {
    const { fullName: { firstName, lastName }, email, password, vehicleType, vehicleNumber } = req.body;
    ...
    const createdDriver = await createDriver({ firstName, lastName, email, password , vehicleType, vehicleNumber });
